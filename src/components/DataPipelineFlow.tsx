import { DATA_PIPELINE_STEPS } from "@/lib/data-sources";
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-stretch">
        {DATA_PIPELINE_STEPS.map((step, index) => (
          <div key={step.id} className="flex flex-1 items-center gap-2">
            ...
            {index < DATA_PIPELINE_STEPS.length - 1 && (
              <>
                <svg
                  className="hidden h-4 w-4 shrink-0 text-indigo-400 lg:block"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={2}
                  stroke="currentColor"
                ...
                <svg
                  className="mx-auto h-4 w-4 shrink-0 rotate-90 text-indigo-400 lg:hidden"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={2}
                  stroke="currentColor"
