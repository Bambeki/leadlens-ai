...
export default function AISignageAudit({ audit }: { audit: SignageAudit }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-indigo-200 shadow-xl">
      {/* Header */}
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-6">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/20 px-3 py-1 text-xs font-bold text-indigo-200 ring-1 ring-indigo-400/30">
            ...
            <p className="mt-1 max-w-lg text-sm text-indigo-300">
              {audit.verdict}
            </p>
          </div>
      ...
      {/* Branding Assessment */}
      <div className="border-b border-indigo-100 bg-gradient-to-r from-indigo-950 to-slate-900 px-6 py-6 sm:px-8">
      ...
      <div className="grid gap-0 lg:grid-cols-2">
        <div className="border-b border-slate-100 p-6 lg:border-b-0 lg:border-r">
          <h3 className="flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-red-600">
          ...
          <ul className="mt-4 space-y-2">
            {audit.weaknesses.map((w) => (
              <li
                key={w}
                className="flex items-center gap-3 rounded-xl border border-red-100 bg-gradient-to-r from-red-50 to-orange-50 px-4 py-3"
              >
                <span className="flex h-2 w-2 shrink-0 rounded-full bg-red-500 shadow-sm shadow-red-500/50" />
                <span className="text-sm font-medium text-red-900">{w}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="p-6">
          <h3 className="flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-emerald-600">
          ...
          <ul className="mt-4 space-y-2">
            {audit.recommendations.map((r) => (
              <li
                key={r}
                className="flex items-center gap-3 rounded-xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-teal-50 px-4 py-3"
              >
                ...
                <span className="text-sm font-medium text-emerald-900">{r}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="grid gap-0 border-t border-slate-100 sm:grid-cols-3">
        ...
        <div className="bg-gradient-to-br from-violet-50 to-indigo-50 p-6">
          ...
          <div className="mt-2 flex items-end gap-2">
            ...
            <p className="mb-1 text-sm text-violet-500">audit accuracy</p>
          </div>
