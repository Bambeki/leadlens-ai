  ...
  return (
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl">
      <div className="flex items-center gap-2 border-b border-slate-200 bg-slate-50 px-4 py-2.5">
        ...
        <div className="mx-auto rounded-md bg-white px-3 py-0.5 text-xs text-slate-400">
      ...
      <header className="border-b border-slate-100">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold text-slate-900">LeadLens AI</span>
          </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-indigo-600/25 transition-all hover:bg-indigo-700"
            >
