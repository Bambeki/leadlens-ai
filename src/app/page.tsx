...
const benefits = [
  {
    ...
    description:
      "Surface potential leads from market signals, business profiles, and public opportunity indicators.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Analyze business opportunities and explain why each prospect matters before outreach begins.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Organize lead information with source names, URLs, evidence summaries, collection dates, and confidence scores.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Score and prioritize prospects so teams can focus on the highest-value opportunities first.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: "CRM Workflow",
    description:
      "Manage conversations, customer responses, meetings, and pipeline stages from discovery through follow-up.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div className="min-h-screen bg-saas-bg">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="lg:mt-12">
            <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-violet-400">
              Vehicle Branding Analysis — current specialized prototype use case
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white">
              Everything needed to discover, qualify, and manage opportunities
            </h2>
            <p className="mt-3 text-lg text-slate-300">
              From lead discovery to outreach and CRM — powered by structured
              data, evidence, and AI-assisted workflows.
            </p>
          </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-white">
            Branding and vehicle-branding opportunities
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-slate-300">
            The current LeadLens prototype uses branding and vehicle-branding
            opportunities as a focused use case for testing lead discovery,
            opportunity scoring, outreach and CRM workflows. The underlying
            platform is intended for broader B2B lead-intelligence applications.
          </p>
        </div>
      </section>
      ...
      <footer className="border-t border-saas-border bg-saas-card py-8">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6">
          ...
          <p className="text-sm text-slate-500">
            Built as an AI-powered lead intelligence and sales workflow platform
          </p>
        </div>
      </footer>
    </div>
